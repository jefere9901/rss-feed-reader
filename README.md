...
| E2E 测试 | `scripts/test-full-download.mjs` | 下载→自动跳转→再次打开显示跳转 全流程 |
| E2E 测试 | `scripts/test-feed-manage.mjs` | 内联改名/改URL + 🟢🟢 状态点验证 |
| E2E 测试 | `scripts/test-opml-icons.mjs` | OPML 导入图标获取验证 |
| E2E 测试 | `scripts/test-readability.mjs` | 反限制全文提取验证 (cnfeat) |
